CLASS zcl_54_exception DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_54_exception IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
      ...
      CATCH cx_sy_arithmetic_overflow.
        out->write( 'Arithmetic Overflow 1' ).
      CATCH cx_sy_zerodivide.
        out->write( 'Division by zero 1' ).
    ENDTRY.
    ...
    TRY.
      ...
      CATCH cx_sy_arithmetic_overflow.
        out->write( 'Arithmetic Overflow 2' ).
      CATCH cx_sy_zerodivide.
        out->write( 'Division by zero 2' ).
    ENDTRY.
