CLASS zcl_54_time_calculations DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_54_time_calculations IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
      ...
      CATCH cx_abap_context_info_error INTO DATA(ex_context).
        out->write( |{ ex_context->get_text(  ) }| ).
    ENDTRY.
